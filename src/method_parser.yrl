Terminals player_symbol command number. %% NOTE: name has to match atom from Lexer
...
request -> command number player_symbol player_symbol : [list_to_atom(method_name(extract_value('$1'))), 
[extract_string_value('$2'), extract_string_value('$3'), extract_string_value('$4')]].
request -> command player_symbol number : [list_to_atom(method_name(extract_value('$1'))), 
